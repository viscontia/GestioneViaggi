...
public class AnaFornitoriService : BaseCrudService<AnaFornitore>
{
    ...
    public AnaFornitoriService(
        ...
        ILogger<AnaFornitoriService> logger,
    ...
    /// GetAllAsync con filtro multitenant e JOIN per descrizioni
    /// </summary>
    public async Task<List<AnaFornitore>> GetAllAsync(int? aziendaIdFilter = null)
    {
        try
        {
            ...
            var list = new List<AnaFornitore>();
    ...
    public override async Task<AnaFornitore> CreateAsync(AnaFornitore entity)
    {
    ...
    public override async Task<AnaFornitore> UpdateAsync(AnaFornitore entity)
    {
    ...
    /// </summary>
    public override async Task<AnaFornitore?> GetByIdAsync(int id)
    {
        try
        {
            await using var connection = await _databaseService.GetConnectionAsync();
    ...
    protected override AnaFornitore MapFromReader(NpgsqlDataReader reader)
    {
    ...
    private AnaFornitore MapFromReaderWithJoins(NpgsqlDataReader reader)
    {
    ...
    private void AddCommandParameters(NpgsqlCommand command, AnaFornitore entity)
    {
    ...
    /// </summary>
    private new void NormalizeEntityBeforeSave(AnaFornitore entity)
    {
    ...
    /// </summary>
    private async Task ValidateDuplicatesAsync(AnaFornitore entity, bool isUpdate)
    {
