-- Aggiornamento: Aggiunge causale_ciclo alle function fn_get_all_transazioni e fn_get_transazioni_by_azienda
-- Necessario per mostrare icona stampa fattura nella DataGrid MovTransazioniPage
-- Data: 2026-03-02
...
RETURNS TABLE (
    ...
    causale_ciclo character varying,
