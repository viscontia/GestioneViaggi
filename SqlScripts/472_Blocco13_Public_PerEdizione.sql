-- ============================================================================
-- Blocco 13 — Fase C: strato pubblico PER-EDIZIONE.
-- fn_web_tour_pubblicati ora emette una riga per CONTENUTO/edizione (viaggio+data):
--   - prezzo e date dalla SINGOLA data (ana_date_viaggi), non piu' aggregati sul viaggio;
--   - difficolta da ana_viaggi.viaggio_difficolta (colonna difficolta rimossa dai contenuti);
--   - immagine principale via web_tour_contenuti_id_fk.
-- ============================================================================

-- 1) Prezzo "da" della SINGOLA edizione (LEAST delle 6 tariffe della data). NULL/0 ignorati.
CREATE OR REPLACE FUNCTION fn_web_prezzo_da_data(p_data_viaggio_id INTEGER)
...
$$;
GRANT EXECUTE ON FUNCTION fn_web_prezzo_da_data(INTEGER) TO anon;

-- 2) Lista tour pubblicati per il sito, PER-EDIZIONE.
