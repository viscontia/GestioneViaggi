-- PULIZIA TOTALE E RIFACIMENTO FUNCTION
-- Rimuovo tutte le possibili varianti per evitare ambiguità
DROP FUNCTION IF EXISTS public.fn_get_all_transazioni();
...
DROP FUNCTION IF EXISTS public.fn_get_transazioni_by_azienda(integer);
...
-- 1. Function per Tutte le Transazioni (usata da SuperAdmin se vuole vedere tutto, o come base)
...
RETURNS TABLE (
    ...
    azienda_codice text, -- Qui mapperemo azienda_id
...
BEGIN
    ...
    SELECT 
        ...
        t.updated_at,
        t.updated_by,
        a.azienda_id::text as azienda_codice, -- CORRETTO: azienda_id invece di azienda_codice
        f.ragione_sociale as fornitore_ragione_sociale, -- CORRETTO: ragione_sociale
        v.valuta_codice_iso,
