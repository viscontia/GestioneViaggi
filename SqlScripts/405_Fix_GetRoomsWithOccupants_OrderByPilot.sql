-- 405_Fix_GetRoomsWithOccupants_OrderByPilot.sql
-- DESCRIZIONE: Corregge ordinamento occupanti per camera: pilota prima, poi passeggeri per cognome/nome.
--              Aggiunge colonna pilot_cognome per ordinare le camere all'interno di ogni tipologia.
-- AUTORE: Antigravity
-- DATA: 2026-04-13

-- Drop necessario perché si aggiunge la colonna pilot_cognome (cambia il return type)
DROP FUNCTION IF EXISTS get_rooms_with_occupants(INTEGER);

-- =================================================================================================
-- FUNCTION: get_rooms_with_occupants
-- DESCRIZIONE: Restituisce camere con occupanti aggregati.
--   - occupant_names / occupant_ids: pilota primo, poi passeggeri in ordine alfabetico cognome+nome
--   - pilot_cognome: cognome del pilota della camera (per ordinare le camere per pilota)
-- =================================================================================================
CREATE OR REPLACE FUNCTION get_rooms_with_occupants(p_data_viaggio_id INTEGER)
RETURNS TABLE(
    alloggio_pk       INTEGER,
    tipo_alloggio     TEXT,
...
COMMENT ON FUNCTION get_rooms_with_occupants(INTEGER) IS
'Restituisce camere con occupanti aggregati. Ordinamento: pilota primo, poi passeggeri per cognome/nome. Colonna pilot_cognome usata per ordinare le camere all''interno della tipologia.';


-- =================================================================================================
-- FUNCTION: fn_get_viaggio_partecipanti_init_data
-- AGGIORNAMENTO: Aggiunge pilotCognome nel JSON delle camere
-- =================================================================================================
