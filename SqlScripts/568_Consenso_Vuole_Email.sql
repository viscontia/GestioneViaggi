-- =============================================================================
-- 568 — Il consenso alla newsletter vuole un indirizzo a cui scrivere
-- =============================================================================
--
-- Trovato durante il test F1 del 2026-09-01: si poteva spuntare il consenso alla
-- newsletter lasciando l'email vuota. Le tre colonne del consenso venivano
-- scritte regolarmente — quindi la prova c'era — ma non c'era nessuno a cui
-- mandare niente.
--
-- La regola sta qui e non nella form perche' le porte sono due, e sul sito di
-- iscrizione il consenso e' proprio il punto che manca ancora (vedi §2.8 della
-- Checklist Go-Live): quando lo si aggiungera', questa regola ci sara' gia'.
-- =============================================================================
