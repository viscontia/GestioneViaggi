CREATE OR REPLACE FUNCTION public.trg_mov_clienti_alloggi_audit() RETURNS trigger LANGUAGE plpgsql AS $function$ BEGIN IF TG_OP = 'INSERT' THEN -- Popola created_by con priorità: my.app_user -> current_user -> 'system'
