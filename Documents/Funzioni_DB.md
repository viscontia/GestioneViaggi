...
| `fn_web_ai_config_get` | p_azienda_id integer | TABLE(soglia_spesa numeric, conteggio_da timestamp with time zone, avvisato_il timestamp with time zone) |  |
