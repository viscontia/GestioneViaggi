...
| `fn_ana_aziende_get_claude_key` | p_azienda_id integer | text |  |
| `fn_ana_aziende_set_claude_key` | p_azienda_id integer, p_key text | integer |  |
...
| `fn_web_tour_pubblicati` | p_azienda_id integer, p_lingua character DEFAULT 'IT'::bpchar | TABLE(viaggio_id integer, contenuto_id bigint, titolo character varying, sottotitolo character varying, descrizione_html text, slug character varying, difficolta character varying, durata_testo character varying, numero_giorni integer, descrizione_web character varying, descrizione_slug character varying, prezzo_da integer, immagine_url text, immagine_storage_path character varying, data_pubblicazione timestamp with time zone, ordine integer) |  |
...
- `fn_web_traduzioni_marca_obsolete`
