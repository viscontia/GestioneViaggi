...
| `fn_ana_tipo_alloggio_upsert` | p_id integer, p_descrizione character varying, p_numero_occupanti integer, p_supplemento character varying, p_genere_fk integer | integer |  |
...
| `fn_ana_tipo_pernottamento_generi_set` | p_pernottamento_id integer, p_generi integer[] | integer | Imposta i generi ammessi da un pernottamento, sostituendo quelli precedenti. Un elenco |
