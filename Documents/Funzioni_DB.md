...
| `fn_web_tour_immagini_reorder` | p_azienda_id integer, p_viaggio_id_fk integer, p_ids bigint[] | integer |  |
| `fn_web_tour_immagini_set_principale` | p_id bigint, p_azienda_id integer, p_viaggio_id_fk integer | integer |  |
