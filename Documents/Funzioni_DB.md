...
- `fn_cliente_ha_alloggi`
- `fn_cliente_ha_iscrizioni`
- `fn_enforce_user_azienda_integrity`
- `fn_get_calendar_data`
- `fn_get_cliente_by_codice_fiscale`
- `fn_get_cliente_by_email`
- `fn_get_cliente_detail`
