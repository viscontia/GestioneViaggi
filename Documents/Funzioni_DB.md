...
- **`fn_web_traduzioni_marca_obsolete(p_azienda_id, p_entita, p_entita_id, p_campo)` → `INTEGER`** (`SqlScripts/462`, Blocco 10) — marca `obsoleto=true` tutte le lingue del campo quando l'IT sorgente cambia.
