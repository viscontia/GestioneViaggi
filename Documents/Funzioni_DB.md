...
| `fn_web_tour_contenuti_clona` | p_contenuto_sorgente bigint, p_data_viaggio_dest integer, p_azienda_id integer | bigint | Clona la scheda web di una edizione su un'altra data dello STESSO viaggio: editoriale, immagini, itinerario, mappe (con abbinamento giornata rimappato) e tutte le traduzioni, conservando revisionato/obsoleto. La copia nasce sempre in bozza. I file su Storage restano condivisi con l'originale. |
