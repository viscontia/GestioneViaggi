...
Riferimenti: [Funzioni_DB.md](../../Documents/Architettura/Funzioni_DB.md), [Gestione_check.md](../../Documents/Architettura/Gestione_check.md), [Implementazione_Contabile.md](../../Documents/Analisi_e_Design/Implementazione_Contabile.md), [checklist go-live](../../Estensione%20Progetto%20WEB/Documenti/2026-07-10-Checklist_Go_Live_PROD.md).
...
Gli script eseguibili futuri restano in `SqlScripts/`, numerati secondo l'ultimo numero realmente disponibile, senza prenotare ora numeri o duplicare quelli del go-live. Deploy locale tramite `./deploy_sql.sh`; aggiornare sempre la parte curata di `Documents/Architettura/Funzioni_DB.md`. Non modificare manualmente l'appendice auto-generata. Il deploy in produzione segue la procedura e le approvazioni del progetto, non il wrapper Docker.
