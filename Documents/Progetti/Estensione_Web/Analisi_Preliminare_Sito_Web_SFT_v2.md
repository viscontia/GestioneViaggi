...
**Posizione:** `Documents/Progetti/Estensione_Web/` (cartella che raccoglie tutti i documenti del progetto).
...
> Tutte multi-azienda (`azienda_id`) e con audit `created/updated`. Tutto l'accesso via **funzioni PL/pgSQL** (zero SQL inline nei servizi), come da architettura del progetto. Documentare in `Documents/Architettura/Funzioni_DB.md` dopo l'implementazione.
