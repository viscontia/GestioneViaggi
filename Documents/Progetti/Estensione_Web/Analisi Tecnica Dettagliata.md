...
- **DB-First**: zero SQL inline nei servizi. Ogni operazione passa da **funzioni PL/pgSQL**. Dopo ogni funzione nuova/modificata → aggiornare `Documents/Architettura/Funzioni_DB.md`.
