...
**Design doc di riferimento:** `Documents/Progetti/Estensione_Web/2026-07-03-Piano_Operativo_Estensione_Web_design.md`.
**Spec campo-per-campo (fonte di verità colonne):** `Documents/Progetti/Estensione_Web/Dettaglio_Tabelle_DB.md` (citata come *Spec §X.Y*).
...
6. **Documenta** (funzioni → parte curata `Documents/Architettura/Funzioni_DB.md`).
7. **Commit**.
...
**Step 5: Documenta** in `Documents/Architettura/Funzioni_DB.md` (parte curata: sezione "Estensione Web / Utility").
**Step 6: Commit.**
...
```
- Aggiornare la parte curata di `Documents/Architettura/Funzioni_DB.md` (nuove tabelle, non solo funzioni) e verificare l'appendice auto-generata.
