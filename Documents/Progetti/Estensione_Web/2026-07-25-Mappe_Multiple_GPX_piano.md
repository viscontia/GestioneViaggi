...
**Design di riferimento:** `Documents/Progetti/Estensione_Web/2026-07-25-Mappe_Multiple_GPX_design.md`
...
**Step 6.** Aggiungere i nuovi constraint a `Helpers/DatabaseExceptionHelper` (messaggi in italiano) — vedi `Documents/Architettura/Gestione_check.md`, mai traduzioni inline nei componenti.
...
**Files:**
- Modifica: `Documents/Architettura/Funzioni_DB.md` (parte curata: `fn_web_tour_mappa_*` aggiornate, `list_by_contenuto`, `fn_web_tour_stato_sezioni` con il ramo mappe)
- Modifica: `Documents/Architettura/ComponentiShared.md` (tab Mappa a elenco, data nelle giornate)
- Modifica: `Documents/Progetti/Estensione_Web/2026-07-10-Checklist_Go_Live_PROD.md` (script 493–495 in §1, range del loop)
- Modifica: `Documents/Progetti/Estensione_Web/2026-07-09-Piano_Test_Estensione_Web.md` (casi: due mappe, doppione rifiutato, eliminazione giornata con mappa, date giornate)
