...
| C13a | In modifica, **attraversa col tabulatore** i campi Comune di nascita e Comune di residenza senza toccarli | Il valore **resta**. ⚠️ Prima veniva cancellato dal solo passaggio del fuoco (difetto 63), in silenzio |
| C13a-bis | Cancella un comune **di proposito** con la «x» del selettore, poi esci dal campo | Resta cancellato, e il campo va in errore: la cancellazione voluta non viene annullata dal ripristino. ⚠️ La «x» **non c'era** ed è stata aggiunta il 2026-09-04 (difetto 68): prima l'unico modo di svuotare il campo era cancellare il testo a mano |
| C13d | Apri l'anagrafica di **VISCONTI ADRIANO** (`visconti.adriano@gmail.com`, scheda SFT) e guarda il **prefisso internazionale** | Mostra **+27**. ⚠️ Prima il campo era vuoto: l'elenco del sito ha dieci prefissi europei e +27 non c'è (difetto 64). Nota: di questa email esistono **due** schede, in aziende diverse — la 22 (azienda 6, +39) e la 3870 (azienda 2 = SFT, +27). Il sito lavora sulla seconda |
