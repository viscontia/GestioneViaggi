...
| C11d | Ripeti fermando il container e **guarda l'indicatore di stato del database** | Oggi resta **verde** per un massimo di 5 minuti: il monitor ha un giro suo e non viene informato dalle chiamate che falliscono. ⚠️ Difetto noto, non ancora corretto (vedi 55) |
