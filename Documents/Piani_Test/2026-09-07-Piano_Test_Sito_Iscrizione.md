...
`Documents/Analisi_e_Design/2026-08-20-Analisi_Validazioni_e_CRUD_AnaClienti.md`.
...
- **La parte CMS nel gestionale** (contenuti web, edizioni, newsletter): ce l'ha il suo piano,
  `Documents/Progetti/Estensione_Web/2026-07-09-Piano_Test_Estensione_Web.md`.
