...
Riferimenti: `Documents/Progetti/Estensione_Web/2026-09-05-Analisi_Scelta_Camere_Step5.md`,
`SqlScripts/599`–`601`.
...
> ⚠️ **Due strade, e non fanno la stessa cosa — di proposito** (accertato il 2026-09-06 su
> segnalazione di Adriano).
>
> **Iscrivendo un partecipante** si può creare solo una sistemazione della capienza di chi si
...
| F7 | **Iscrizione Veloce**: scegli un viaggio in albergo, una data, e chiedi la sistemazione | Propone CAMERA SINGOLA. ⚠️ In elenco ci sono **solo le sistemazioni da un posto**: prima c'erano tutte, matrimoniale compresa, e sceglierla portava a un rifiuto al salvataggio |
| F7a | In **dashboard**, guarda il pulsante verde dell'iscrizione veloce | ⚠️ Si chiama **«Iscrizione Veloce — solo pilota»**. Passandoci sopra il mouse: «iscrive UNA persona che viaggia da sola… per una coppia usa Gestisci Partecipanti sulla partenza» — dice anche **dove andare**, non solo che lì non si può |
| F7b | Guarda in cima alla scheda | ⚠️ C'è scritto a che cosa serve: «iscrive **una persona che viaggia da sola**… per una coppia o una famiglia usa Partecipanti sulla partenza». Senza, chi ci prova con una coppia non capisce perché la matrimoniale non c'è |
