...
| J5b | Apri i partecipanti di una partenza **in corso** (iniziata ieri, finisce domani) | «Nuovo» è **spento**, e il motivo dice «è già iniziata il …», non «si è conclusa» (difetto 76). ✅ **Passato** il 2026-09-04 |
| J5c | Nelle **Date del viaggio**, prova a spuntare «effettuato» su una partenza **futura** | La casella è **spenta**: non si può nemmeno premere. Il suggerimento dice perché, e sotto compare «Si potrà spuntare dal gg/mm/aaaa, primo giorno di viaggio». ⚠️ Eseguito il 2026-09-04: **fallito** — si spuntava, si salvava, e l'errore arrivava dal database a cose fatte. ✅ **Passato** il 2026-09-04 |
| J5c-bis | Nello stesso dialogo, **sposta la data di inizio** a ieri senza chiudere | La casella si **accende subito**: guarda la data che hai davanti, non quella salvata. ✅ **Passato** il 2026-09-04 |
