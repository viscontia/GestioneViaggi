...
**Riferimento design:** `Documents/Analisi_e_Design/2026-07-16-SMTP_TestConnessione_Diagnostica_e_Unmask-design.md`
...
- Docs: `Documents/Architettura/Funzioni_DB.md`
...
Aggiungi la funzione a `Documents/Architettura/Funzioni_DB.md` (sezione SMTP, come `fn_get_smtp_config_for_email`).
```bash
git add SqlScripts/NNN_Smtp_Secrets_Get.sql Documents/Architettura/Funzioni_DB.md
...
**Files:**
- Modify: `Documents/Architettura/ComponentiShared.md` (dialog SMTP: nuovo toggle), `Documents/Architettura/Gestione_check.md` (SmtpErrorTranslator come punto centralizzato messaggi SMTP)
...
**Step 3: Commit**
```bash
git add Documents/Architettura/ComponentiShared.md Documents/Architettura/Gestione_check.md
...
- Script SQL 480 (o successivo) va aggiunto anche alla checklist Go-Live PROD (`Documents/Progetti/Estensione_Web/2026-07-10-Checklist_Go_Live_PROD.md`).
