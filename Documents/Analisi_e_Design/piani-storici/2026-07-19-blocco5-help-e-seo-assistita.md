...
**Riferimento design:** `Documents/Analisi_e_Design/2026-07-19-Blocco5_HelpContestuale_e_SEO_Assistita-design.md`
...
**Files:** Create `SqlScripts/NNN_FnWebTourPubblicati_Meta.sql`; Modify `Documents/Architettura/Funzioni_DB.md`; checklist go-live.
...
**Files:** `Documents/Architettura/ComponentiShared.md` (FieldHelp + note Blocco 5); `Documents/Architettura/Funzioni_DB.md` (già in Task 4). Poi `/graphify --update`.
