...
(`Documents/Analisi_e_Design/2026-08-20-Analisi_Validazioni_e_CRUD_AnaClienti.md`) ha mostrato che **le sue regole non
...
Aggiornare `Documents/Progetti/Estensione_Web/2026-07-10-Checklist_Go_Live_PROD.md` §2.8 e §4: la
...
- **Due repository separati** che devono restare allineati: ogni funzione nuova va documentata in
  `Documents/Architettura/Funzioni_DB.md` prima che Flask la usi, perché è l'unico contratto condiviso.
