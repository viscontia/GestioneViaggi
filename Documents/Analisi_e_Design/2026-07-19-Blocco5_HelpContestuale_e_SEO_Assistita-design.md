...
- `SqlScripts/NNN_*.sql` — `fn_web_tour_pubblicati` +meta con fallback; `Documents/Architettura/Funzioni_DB.md`; checklist go-live (grant anon colonnare)
- eventuale modello/mapping C# del consumer di `fn_web_tour_pubblicati` (se esiste già lato gestionale)
- `Documents/Architettura/ComponentiShared.md` (FieldHelp)
