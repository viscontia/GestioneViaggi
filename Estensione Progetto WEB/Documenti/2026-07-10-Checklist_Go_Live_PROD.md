...
> Nota: questa tabella dettaglia i primi script; per `467`–`517` c'è la **seconda tabella** subito sotto. I riquadri qui sopra restano come approfondimento tematico (grant `anon`, `SECURITY DEFINER`, re-model Blocco 13), non come elenco di deploy.
...
- [ ] Applicati in ordine i **107** script 406–517 su PROD (§1) senza errori, **escluso `499_Rollback_EstensioneWeb.sql`**.
