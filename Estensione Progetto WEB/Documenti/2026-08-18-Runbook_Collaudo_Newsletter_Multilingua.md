...
>
> **Stato al 2026-08-19: collaudo chiuso.** Tutti i gruppi da A a O sono stati eseguiti e passano.
> Le correzioni emerse strada facendo sono nei rilievi R1-R10, ciascuna con il proprio gruppo di
> verifica. Restano fuori, per decisione: il percorso SuperAdmin (nota al gruppo I) e §8-G/§8-L6,
> non più eseguibili dopo la rimozione del motore che traduceva all'invio.
>
...
> **Esito del 19/08: gruppo J completo.** J3 e J4 (ex B2-B3) sono risultati **superati a monte**:
> la validazione del testo vuoto sta nel dialogo del blocco, non nella pagina.
...
| ✅ O2 | Stesso tab, cursore sull'email | TAB, poi SHIFT+TAB | Vai su **Motivo** e torni indietro — *verificato il 19/08* |
...
| ✅ O5 | Tab **Impostazioni** | TAB dai campi del footer | Si arriva a **Colonne** e poi ad **Allineamento** — *verificato il 19/08* |
...
> **Gruppo O completo il 19/08**: O1-O6 tutti verificati.
